...
function genComponentStyleHook(componentName, styleFn, getDefaultToken) {
  ...
  return function (prefixCls) {
    ...
    const calc = (0, _useUniqueMemo.default)(() => {
      ...
      if (cssVar) {
        Object.keys(options.unitless || {}).forEach(key => {
          ...
          unitlessCssVar.add((0, _cssinjs.token2CSSVar)(key, getCompVarPrefix(component, cssVar.prefix)));
        });
      }
      return (0, _cssinjs.genCalc)(type, unitlessCssVar);
...
const genStyleHooks = (component, styleFn, getDefaultToken, options) => {
  ...
  const compUnitless = Object.assign(Object.assign({}, _useToken.unitless), {

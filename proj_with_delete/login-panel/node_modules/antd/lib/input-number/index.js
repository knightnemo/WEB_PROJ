...
var _InputAddon = _interopRequireDefault(require("../_util/InputAddon"));
...
const InputNumber = /*#__PURE__*/React.forwardRef((props, ref) => {
  if (process.env.NODE_ENV !== 'production') {
    const {
      deprecated
    } = (0, _warning.devUseWarning)('InputNumber');
  ...
  const element = /*#__PURE__*/React.createElement(_rcInputNumber.default, Object.assign({
    ...
    prefix: prefix,
    suffix: suffixNode,
    addonBefore: (0, _InputAddon.default)(addonBefore),
    addonAfter: (0, _InputAddon.default)(addonAfter),
    classNames: {

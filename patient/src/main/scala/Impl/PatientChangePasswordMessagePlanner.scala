...
import APIs.PatientAPI.PatientChangePasswordMessage
import cats.effect.IO
import io.circe.generic.auto.*

case class PatientChangePasswordMessagePlanner(userName: String, oldPassword: String, newPassword: String, override val planContext: PlanContext) extends Planner[String]:
